# -*- coding: utf-8 -*-
"""
Created on Fri Jan 31 14:42:20 2020
...
df = pd.read_excel('Incise Complaints - Copy (2).xls')
...
plt.title('2019 Brookings Incise Drape Complaint Pareto')
plt.grid(linestyle='dotted')
plt.tight_layout()
plt.savefig('2019 Brookings Incise Drape Complaint Pareto')
...
plt.title('2019 Brookings Incise Complaint Trending by Month')
plt.grid(linestyle='dotted')
plt.tight_layout() 
plt.show()
plt.savefig('2019 Brookings Incise Complaint Trending by Month')
