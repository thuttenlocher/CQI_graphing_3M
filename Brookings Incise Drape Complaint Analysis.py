# -*- coding: utf-8 -*-
"""
Created on Thu Apr 11 16:16:36 2019
...
df = pd.read_excel('Incise Complaints.xls')
...
plt.tight_layout()
plt.savefig('Brookings Incise Complaint Pareto - Yearly Comparison')
...
"""
months = np.array(range(1, 25))
date_series = np.array(str(date - dateutil.relativedelta.relativedelta(months)))

complaint_count_dataframe = pd.DataFrame(months, columns=['Month'])
"""
...
plt.title('Brookings Incise Complaints - Previous 12 Months')
plt.grid(linestyle='dotted')
...
plt.xticks(rotation=90)
plt.yticks(np.arange(0, 21, 2.0))
plt.title('Brookings Incise Complaints - Previous 12-24 Months')
plt.grid(linestyle='dotted')
plt.tight_layout() 
plt.show()
plt.savefig('Brookings Incise Complaint Trending')
...
plt.xticks(rotation=45)
plt.yticks(np.arange(0, 5, 1.0))
plt.title('Brookings Incise Complaint Pareto - November 2019')
plt.grid(linestyle='dotted')
plt.tight_layout()
plt.savefig('Brookings Incise Complaint Pareto - November 2019')
"""
